...
public class HospitalService {
	...
	public String insertHospital(@FormParam("hosCode") String hosCode, @FormParam("hosName") String hosName,
			@FormParam("password") String password, @FormParam("address") String address,
			@FormParam("mobile") String mobile, @FormParam("email") String email,
			@FormParam("webAddress") String webAddress) {

		String output = hospitalObj.insertHospital(hosCode, hosName, password, address, mobile, email, webAddress);
	...
	public String updateHospital(String hospitalData) {
		...
		String hosCode = hospitalJsonObject.get("hosCode").getAsString();
		...
		String output = hospitalObj.updateHospital(hosID, hosCode, hosName, password, address, mobile, email,
				webAddress);
